...
> **工程指标**：全站 162 个多语言静态 SSG 页面（突破 150+ 标杆），First Load JS 87.1 kB，4 语言 553 个字典键 100% 对齐，四大门禁 100% 通过  
> **蓝图对齐**：完整贯彻《跨乐器重构规范与经验蓝图》（MULTI_INSTRUMENT_SITE_BLUEPRINT.md），完成第零步排毒、VoC 痛点驱动、四大标准模块重塑与交响黑金殿堂升级  
> **文档归档日期**：2026年9月  
...
## 9. 跨乐器重构规范与经验蓝图升级实战（双簧管专属篇）

### 9.1 第零步排毒法则（彻底杜绝跨乐器历史残留）
- **毒素清除**：克隆或多乐器模板迁移时，必须通过全库正则扫描清除前一个乐器的专属名词（如巴松大管的次中音谱表、靴管翼管、旧练习曲等）。
- **自动化清洗脚本**：编写 `scripts/clean-dictionaries.mjs`，递归清洗 `messages/zh.json`, `en.json`, `de.json`, `ja.json`，确保四语种 553 键完全聚焦于双簧管（Oboe / Hautbois / Oboe / オーボエ）。

### 9.2 VoC 真实用户声音驱动的内容矩阵
深挖 Reddit r/oboe 与 IDRS 国际双簧管协会高频讨论痛点，打造了具有强烈专业壁垒的内容护城河：
1. **6 大传世曲谱中心 (`/scores` & `/scores/[slug]`)**：
   - 莫扎特 C大调协奏曲 K.314、理查·施特劳斯协奏曲、奇马罗萨协奏曲、马尔切洛柔板 Adagio、亨德尔协奏曲 HWV 287、费林 48 首练习曲 Op.31 No.1。
   - 每部作品配备乐理移调解密、乐团 Audition 考核指标、四步慢练指南与 PDF 分谱免费直链。
2. **6 大实战百科指南 (`/knowledge` & `/knowledge/[slug]`)**：
   - 上管温差防裂与鹅毛吸水救急、二手双簧管验货真空密封测试、告别咬唇下颌减压生理力学、高音 E6-A6 咽腔 Voicing 声学、左手 F vs 分叉 F 瞬间决策树、CO2 排浊呼吸悖论。
   - 挂载 Article + FAQPage 双结构化数据。

### 9.3 四大标准模块与黑金美学落地
- **`/fingering` 运指中心**：左中右三栏一体化按键工作台（左栏 23 键 SVG 联动；中栏 G-clef 高音五线谱 + 持续 Drone 对音；右栏全音域高密度表格），集成 1200px 极清 Canvas 指法海报卡一键生成导出；
- **`/tools` 琴房工作台**：7 合 1 数字化练习中枢（声学调音、节拍器、持续 Drone、15分钟阶梯热身、F键决策器、CO2排浊训练器、首席15秒仪式）；
- **首页黑金殿堂重塑**：主次双 CTA（指法工作台 + 琴房工作台）、声学 HUD 仪表盘（36半音/23键/7合1/150+矩阵）、3大场景分流通关通道（新手启蒙、考级备考、乐团首席）；
- **全站静态页面突破 162 个**：100% 达成 RSC First、无跨语言 fallback、四大门禁全部绿标通过。

---
*报告归档完毕，OboLib 已全面达到出海独立站最高工业级工程与专业学术双重标准。*
